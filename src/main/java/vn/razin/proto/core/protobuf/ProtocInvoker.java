...
public class ProtocInvoker {
    ...
    public FileDescriptorSet invoke() throws ProtocInvocationException {
        ...
        Path descriptorPath;
        File file = new File(System.getProperty("user.dir") + File.separator + "compileProto" + dateFormat.format(new Date()) + ".pb.bin");
        descriptorPath = Paths.get(file.getPath());
        //descriptorPath = Files.createTempFile("compileProto", ".pb.bin");
